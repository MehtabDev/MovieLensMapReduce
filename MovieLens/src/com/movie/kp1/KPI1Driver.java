...
public class KPI1Driver {
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job1.setJarByClass(KPI1Driver.class);
...
//		FileOutputFormat.setOutputPath(job1, new Path(otherArgs[2]));
		...
		if (code == 0) { // if first job get executed successfully
			...
			job2.setJarByClass(KPI1Driver.class);
			...
			job2.setMapperClass(KPI1Mapper.class);
			job2.setReducerClass(KPI1Reducer.class);
